...
__END__
diff -Nur tmux-1.4/server.c tmux-1.4.new/server.c
--- tmux-1.4/server.c	2010-06-23 09:21:39.000000000 +1000
+++ tmux-1.4.new/server.c	2010-11-29 08:48:48.000000000 +1100
@@ -35,6 +35,8 @@
 #include <time.h>
 #include <unistd.h>
